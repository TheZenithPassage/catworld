...
- **current lifecycle state**: layer-1 handoff-ready evidence `H=78329c6f45793583d4d0e46a96ad54066989ba8d` is remotely durable; literal-H recording head `R = SELF/HEAD` is being established
- **current readiness**: #273 and #274 are handoff-ready but held with permissions false; dispatch remains prohibited until R is normally pushed/fetched, current remote equality to R passes, and H-to-R ancestry passes; #275 remains dependency-blocked
...
|-------|-------------|--------------|-----------------------|-------------|-------------------|-------------|-------------------|-------------------|
| #273 layer1-a | `https://github.com/TheZenithPassage/catworld/issues/273` / open | none | `specs/273-260-fixture-layer1-a/`; `samples/result.md` | handoff-ready; actual Git context and content validated against `C2` | held-preflight / pending | implementation false; delivery false | authoritative canonical F `32fe5281412d44861c0b040e4d9a7fe96cea10b00bdc8dcdfa035e9ff5d56811`; H `78329c6f45793583d4d0e46a96ad54066989ba8d`; `R = SELF/HEAD`; L/A and child identity pending | push/fetch R and prove equality/ancestry before held dispatch |
| #274 layer1-b | `https://github.com/TheZenithPassage/catworld/issues/274` / open | none | `specs/274-260-fixture-layer1-b/`; `samples/result.md` | handoff-ready; actual Git context and content validated against `C2` | held-preflight / pending | implementation false; delivery false | authoritative canonical F `37c8c99634ae0216c0f2e556f390728c90cc99b0905719efd3099a67b10268ba`; H `78329c6f45793583d4d0e46a96ad54066989ba8d`; `R = SELF/HEAD`; L/A and child identity pending | push/fetch R and prove equality/ancestry before held dispatch |
...
|-------|-------------------------|-----------------------|---|---|------------------|
| #273 | `sidecar/273-260-fixture-layer1-a@421b2ac250c05c59eb3cade06b4056e02a6c8415`; exact planned worktree; clean; no remote ref | `32fe5281412d44861c0b040e4d9a7fe96cea10b00bdc8dcdfa035e9ff5d56811`, freshly recomputed from the exact 21-field payload after Git creation | `78329c6f45793583d4d0e46a96ad54066989ba8d`; normally pushed and fetched-equal | `SELF/HEAD`; this commit stores literal H; push/fetch pending | pending / pending / none |
| #274 | `sidecar/274-260-fixture-layer1-b@421b2ac250c05c59eb3cade06b4056e02a6c8415`; exact planned worktree; clean; no remote ref | `37c8c99634ae0216c0f2e556f390728c90cc99b0905719efd3099a67b10268ba`, freshly recomputed from the exact 21-field payload after Git creation | `78329c6f45793583d4d0e46a96ad54066989ba8d`; normally pushed and fetched-equal | `SELF/HEAD`; this commit stores literal H; push/fetch pending | pending / pending / none |

No held child has been dispatched. H itself could not contain its own literal
SHA; this immediately following bounded `R = SELF/HEAD` recording commit stores
exact H. Dispatch requires fetched current remote equality to R and ancestry
proof from H to R after R is published.
...
|----------|--------|--------|----------------|-------------|--------------|--------------------|
| Coordinator | `sidecar/272-coordinator-260-live-sidecar-fixture` | `origin/main@047569718767859289b9f48d68b635b8f7b7f1ac` | `C:\Users\moshe\Desktop\catworld-sidecar-worktrees\sidecar-260-5522748a7cd34cc0b35d29b9c10fc8bb\272-coordinator-260-live-sidecar-fixture` | initial head `421b2ac250c05c59eb3cade06b4056e02a6c8415` and H `78329c6f45793583d4d0e46a96ad54066989ba8d` published; `R = SELF/HEAD` | fetched-equal to H before R; R push pending | recorded for this run |
...
| Layer-1 recording head R | `SELF/HEAD` | exact literal-H storage, H ancestry, unchanged launch/permissions, no-result, no-identity review | passed | normal push/fetch, current remote equality to R, and H-to-R ancestry remain required before dispatch |
...
|-------|-------------|-------------------|----|-------|-------------------|-------------|----------------------------|----------------------|---------|
| #273 | handoff-ready; actual context validated | created clean at `421b2ac250c05c59eb3cade06b4056e02a6c8415` / exact recorded path | none | 1 | held-preflight / pending | false / false | H `78329c6f45793583d4d0e46a96ad54066989ba8d`; `R = SELF/HEAD`; L/A pending; no dispatch identity | H remote-durable; R publication pending / release not started | ineligible: pending final PR merge |
| #274 | handoff-ready; actual context validated | created clean at `421b2ac250c05c59eb3cade06b4056e02a6c8415` / exact recorded path | none | 1 | held-preflight / pending | false / false | H `78329c6f45793583d4d0e46a96ad54066989ba8d`; `R = SELF/HEAD`; L/A pending; no dispatch identity | H remote-durable; R publication pending / release not started | ineligible: pending final PR merge |
...
- normally push/fetch this exact R storing literal H with permissions false, then prove current remote equality and H ancestry;
