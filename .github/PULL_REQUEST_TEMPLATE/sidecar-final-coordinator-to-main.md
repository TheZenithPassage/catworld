...
- #<child-pr-number> for #<child-issue>
- #<child-pr-number> for #<child-issue>

Changes:
- <important coordinator-level or integration change>
- <important coordinator-level or integration change>
...
- This final PR is prepared only after all child PRs have been integrated into
  the coordinator branch and integrated coordinator validation is fresh.
