CREATE TABLE nightly_reference_rates (
    ...
    nightly_rate DECIMAL(19, 4) NULL,
    created_at DATETIME(6) NOT NULL,
    updated_at DATETIME(6) NOT NULL,
    PRIMARY KEY (category),
    CONSTRAINT chk_nightly_reference_rates_category
        CHECK (category IN ('ONE_CAT', 'TWO_CATS', 'THREE_CATS')),
...
CREATE TABLE nightly_reference_rate_changes (
    ...
    category VARCHAR(20) NOT NULL,
    previous_nightly_rate DECIMAL(19, 4) NULL,
    new_nightly_rate DECIMAL(19, 4) NULL,
...
VALUES
    ...
    ('THREE_CATS', NULL, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
